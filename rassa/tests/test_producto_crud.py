...
def _small_png():
    return (
        ...
        b"\x49\x48\x44\x52\x00\x00\x00\x01\x00\x00\x00\x01"
        b"\x08\x02\x00\x00\x00\x90\x77\x53\xde\x00\x00\x00"
        b"\x0c\x49\x44\x41\x54\x08\xd7\x63\xf8\xcf\xc0\x00"
        b"\x00\x00\x02\x00\x01\xe2\x21\xbc\x33\x00\x00\x00"
